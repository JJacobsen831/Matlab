function [StnDist, StnCorr] = CrossShelfCorr(r, N)
...
CalStnPairDist = NaN(500, length(CalLineName));
...
NHLNute = RegionNute.NO3(63001:(2*63000),r);

NHLStnPairDist = NaN(500,1);
...
StnDist = [StnPairDist, NHLStnPairDist, THLStnPairDist];
StnCorr = [StnPairR, NHLStnPairR, THLStnPairR];
