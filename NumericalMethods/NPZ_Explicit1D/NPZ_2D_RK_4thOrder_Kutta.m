...
% ***==================================================================***
% time step
tau = 86400/45;         %seconds
maxdays = 200;        %days

% ***==================================================================***
% Runge method parameters
a1 =1; a2=2; a3=2; a4=1;    
...
for istep =1:n_step
    ...
    [k1_dN, k1_dP, k1_dZ] = dNPZdt_ExplicitMM(Nute, Phyt, Zoo, ...
                            zvec,Vm, Ks, Kext,Rm, ...
                            Lambda, gamma, m, g);
    [k2_dN, k2_dP, k2_dZ] = dNPZdt_ExplicitMM(Nute+0.5*k1_dN*tau, ...
                            Phyt+0.5*k1_dP*tau, ...
                            Zoo+0.5*k1_dZ*tau, zvec, ...
                            Vm, Ks, Kext,Rm,Lambda, gamma, m, g);
    [k3_dN, k3_dP, k3_dZ] = dNPZdt_ExplicitMM(Nute+0.5*k2_dN*tau, ...
                            Phyt+0.5*k2_dP*tau, ...
                            Zoo+0.5*k2_dZ*tau, zvec, ...
                            Vm, Ks, Kext,Rm,Lambda, gamma, m, g);
    [k4_dN, k4_dP, k4_dZ] = dNPZdt_ExplicitMM(Nute+k3_dN*tau, ...
                            Phyt+k3_dP*tau, ...
                            Zoo+k3_dZ*tau, zvec, ...
                            Vm, Ks, Kext,Rm,Lambda, gamma, m, g);
