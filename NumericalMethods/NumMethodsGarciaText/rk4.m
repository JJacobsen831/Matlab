...
%  tau = step size (dt)
%  derivsRK = right hand side of ODE; derivsRK is the name of the function
%             which returns dx/dt Calling format derivsRK(x,t,param).
%  param = extra parameters passed to derivsRK
% Output arguments - 
%  xout = new value of x after step size tau
half_tau = 0.5*tau;
