...
%Adaptive R-K routine
%Inputs
%   x           Current value of the dependent variable
%   t           Independent variable (usually time)
%   tau         Step size (dt)
%   err         Desired fractional local truncation error
%   derivsRK    Right hande side of the ODE; derivsRK is
%               the name of the function which returns dx/dt
...
for iTry=1:maxTry
    ...
    %* Estimate new tau value (including safty factors)
    tau_old = tau;
